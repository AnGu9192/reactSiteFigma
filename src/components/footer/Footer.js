        ...
        <div className="footer__content">
          ...
          <address className="footer__address">
            <div className="footer__contact">
              <h2 className="footer__title footer__title-sn">Номер для заказа</h2>
              <a className="footer__link-phone" href="tel:+7(930)833-38-11">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
                ...
                <span>+7930833-38-11</span>
              </a>
            </div>

            <div className="footer__contact">
              <h2 className="footer__title footer__title-sn">Мы в соцсетях</h2>
              <ul className="footer__list">
                <li className="footer__list-item">
                  <a href="/" className="footer__link-sn" aria-label="wk">
                    <svg
                      width="36"
                      height="36"
                      viewBox="0 0 36 36"
                ...
                <li className="footer__list-item">
                  <a href="#" className="footer__link-sn" aria-label="telegram">
                    <svg
                      width="36"
                      height="36"
                      viewBox="0 0 36 36"
